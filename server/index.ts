...
app.use((req, res, next) => {
  const csp = [
    ...
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://replit.com https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net https://yastatic.net https://*.yastatic.net https://rutube.ru https://*.rutube.ru https://www.youtube.com https://*.youtube.com https://youtube-nocookie.com https://*.youtube-nocookie.com https://vk.com https://*.vk.com",
