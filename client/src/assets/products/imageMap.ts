...
import product8934_1 from './concrete/8934-1.jpg';
import product8934_2 from './concrete/8934-2.jpg';
...
const specificImageMap: Record<string, string[]> = {
  '8934': [product8934_1, product8934_2], // Закат 300x600 - has two real photos
