  ...
  return (
    <section id="installation" className="py-12 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4 lg:px-6">
        <h2 className="text-2xl lg:text-4xl font-bold text-primary text-center mb-8 lg:mb-16">МОНТАЖ</h2>
        
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-6 lg:p-8 rounded-lg shadow-sm mb-6 lg:mb-8">
            <h3 className="text-xl lg:text-2xl font-bold text-primary mb-4 lg:mb-6">Краткая инструкция</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {steps.map((step) => (
                <div key={step.number} className="text-center">
                  ...
                  <h4 className="font-bold text-primary mb-2 text-sm lg:text-base">{step.title}</h4>
