    ...
    <footer className="bg-[#2f378b] text-white py-8 lg:py-16">
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <div className="border-t border-gray-700 mt-8 lg:mt-12 pt-6 lg:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center md:grid md:grid-cols-3 md:gap-4">
            {/* Левая часть - копирайт */}
            <div className="flex justify-start">
              <p className="text-xs lg:text-sm text-gray-400">©2025. АЛЬТА СЛЭБ - SPC панели.</p>
            </div>
            
            {/* Центральная часть - иконки социальных сетей */}
            <div className="flex justify-center space-x-3 lg:space-x-4 mt-3 md:mt-0">
            ...
            {/* Правая часть - ссылка разработчика */}
