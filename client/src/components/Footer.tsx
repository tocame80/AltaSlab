      ...
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <div className="border-t border-gray-700 mt-8 lg:mt-12 pt-6 lg:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-3 lg:space-x-4 mt-3 lg:mt-4 md:mt-0">
              ...
              <button
                onClick={scrollToTop}
                className={`ml-4 w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-[#e90039] hover:bg-[#c8002f] transition-colors flex items-center justify-center text-white ${isVisible ? '' : 'opacity-50'}`}
